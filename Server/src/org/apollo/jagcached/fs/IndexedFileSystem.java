...
public final class IndexedFileSystem implements Closeable {
	...
	public IndexedFileSystem(File base, boolean readOnly) throws Exception {
		...
		// caches the crc table
		getCrcTable();
	}

	/**
	 * Checks if this {@link org.apollo.jagcached.fs.IndexedFileSystem} is read only.
	 *
	 ...
	 *
	 * @param fd The {@link org.apollo.jagcached.fs.FileDescriptor} which points to the file.
	 * @return The {@link org.apollo.jagcached.fs.Index}.
	 ...
	 * @throws java.io.IOException if an I/O erorr occurs.
	 */
	 ...
	 * @return A {@link java.nio.ByteBuffer} which contains the contents of the file.
	 * @throws java.io.IOException if an I/O error occurs.
	 */
