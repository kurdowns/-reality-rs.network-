...
public final class RequestDispatcher {
	 ...
	 */
	private static final BlockingQueue<ComparableChannelRequest<OnDemandRequest>> onDemandQueue = new PriorityBlockingQueue<>();
	...
	public static void dispatch(Channel channel, OnDemandRequest request) {
		...
		onDemandQueue.add(new ComparableChannelRequest<>(channel, request));
	}
