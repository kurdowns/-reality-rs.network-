...
public class SpriteLoader {
	...
	public static void createSprite(SpriteLoader sprite) {
		...
		writeFile(new File(directory.getAbsolutePath() + System.getProperty("file.separator") + sprite.id + ".png"),
				sprite.spriteData);
	...
	/**
	 * Loads the sprite data and index files from the cache location. This can be edited to use an archive such as
	 * config or media to load from the cache.
	 *
	 * @param archive
	 */
