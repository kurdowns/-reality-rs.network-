...
public class Packet {
	...
	public short getLEShortA() {
		int i = (this.get() - 128 & 0xFF) | ((this.get() & 0xFF) << 8);
		if (i > 32767) {
			i -= 0x10000;
		}
		return (short) i;
	...
	public short getLEShort() {
		int i = (this.get() & 0xFF) | ((this.get() & 0xFF) << 8);
		if (i > 32767) {
			i -= 0x10000;
		}
		return (short) i;
	 ...
	 */
	public int getInt2() {
		final int b1 = this.get() & 0xFF;
		final int b2 = this.get() & 0xFF;
		final int b3 = this.get() & 0xFF;
		final int b4 = this.get() & 0xFF;
	...
	public int getTriByte() {
		return ((this.get() << 16) & 0xFF) | ((this.get() << 8) & 0xFF) | (this.get() & 0xFF);
	}
	...
	public short getShortA() {
		int i = ((this.get() & 0xFF) << 8) | (this.get() - 128 & 0xFF);
		if (i > 32767) {
			i -= 0x10000;
		}
		return (short) i;
