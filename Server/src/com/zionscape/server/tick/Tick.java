...
/**
 * Represents a task that is executed in the future, once or periodically. Each "tick" represents 0.6ms, or one game
 * loop.
 *
 * @author Michael Bull
 */
public abstract class Tick {
	 ...
	 * ============================================================
	 * 
	 * tickDelay = the delay in ticks between consecutive executions. e.g. a combat event may run at 3 ticks, which mean
	 * each 3*600 ms it is executed
	 * 
	 * remainingTicks = the number of ticks until this tickable next runs. e.g. the tick delay will be 1 if it'll be ran
	 * in the next cycle.
	 */
	/**
	...
	/**
	 * The execute method is called when the tick is run. The general contract of the execute method is that it may take
