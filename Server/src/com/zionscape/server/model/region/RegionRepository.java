...
/**
 * A repository of {@link Region}s, backed by a {@link java.util.HashMap} of {@link RegionCoordinates} that correspond to their
 * appropriate regions.
 *
 * @author Major
 */
public final class RegionRepository {
	...
	/**
	 * Gets the {@link Region} that contains the specified {@link Location}. If the Region does not exist in this
	...
	public Region fromLocation(Location location) {
		return get(RegionCoordinates.fromLocation(location));
	}
	...
	/**
	 * Gets a shallow copy of the {@link java.util.List} of {@link Region}s. This will be an {@link com.google.common.collect.ImmutableList}.
	 *
	 * @return The List.
	 */
