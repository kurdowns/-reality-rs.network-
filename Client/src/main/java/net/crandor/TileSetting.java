...
final class TileSetting {
    ...
    public boolean isWalkableB(int i, int j, int k, int l, int i1, int j1, int k1) {
        int l1 = (j + j1) - 1;
        int i2 = (i + l) - 1;
        if (k >= j && k <= l1 && k1 >= i && k1 <= i2)
            return true;
        if (k == j - 1 && k1 >= i && k1 <= i2
                && (clipData[k - anInt290][k1 - anInt291] & 8) == 0
                && (i1 & 8) == 0)
            return true;
        if (k == l1 + 1
                && k1 >= i
                && k1 <= i2
                && (clipData[k - anInt290][k1 - anInt291] & 0x80) == 0
                && (i1 & 2) == 0)
            return true;
        return k1 == i - 1
                && k >= j
                && k <= l1
                && (clipData[k - anInt290][k1 - anInt291] & 2) == 0
                && (i1 & 4) == 0
                || k1 == i2 + 1
                && k >= j
                && k <= l1
                && (clipData[k - anInt290][k1 - anInt291] & 0x20) == 0
                && (i1 & 1) == 0;
    }
